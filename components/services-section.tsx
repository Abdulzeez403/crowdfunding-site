    ...
    <section id="services" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in-up">
          ...
          <h2 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">Comprehensive Solutions</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            We offer comprehensive marketing and fundraising solutions tailored to your specific needs and budget.
          </p>
        </div>
            ...
            return (
              ...
              >
                <CardHeader className="text-center pb-4">
                  <div
                    className={`w-20 h-20 ${getColorClasses(color)} rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300`}
                  >
                    <IconComponent className="h-10 w-10" />
                  </div>
                  <CardTitle className="text-2xl font-bold text-gray-900 mb-2">{service.title}</CardTitle>
                  <div className="text-3xl font-bold text-blue-600">{service.priceRange}</div>
                </CardHeader>
